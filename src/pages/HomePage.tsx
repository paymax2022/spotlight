...
const HomePage = () => {
  ...
  const newsItems = [
    { img: "/newsOne.png", title: "Timeless Entertainment Factory is Staging Talent Hunt" },
    { img: "/newsTwo.png", title: "Timeless Entertainment Factory is Staging Talent Hunt" },
    { img: "/newsThree.png", title: "Timeless Entertainment Factory is Staging Talent Hunt" },
    { img: "/newsFour.png", title: "Timeless Entertainment Factory is Staging Talent Hunt" },
  ];
     ...
     <div className="flex justify-center mt-16">
      ...
      <div className="grid grid-cols-3 gap-5">
        {movieItems.map((image, index) => (
          ...
          >
            <Image src={image} alt="Movie" width={100} height={100} className="rounded-full" />
          </div>
        ))}
      </div>
   </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {newsItems.slice(0, visibleNews).map((news, index) => (
          <div key={index}>
            ...
            <a href="#" className="text-blue-400 text-xs">READ MORE</a>
          </div>
        ))}
      </div>
