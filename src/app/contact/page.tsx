...
const Page = () => {
  ...
  const [paramAmount, setparamAmount] = useState<string | null>(null);
  const [paramPoint, setParamPoint] = useState<string | null>(null);
    ...
    <div className="px-6">
      ...
      {user && (
        <div className="mt-10">
          <div className="flex gap-10">
            ...
            <div>
              <div className="text-2xl flex gap-4 mt-7">
                <div className="flex gap-2 font-bold text-lg text-white">
          ...
          <div className="flex justify-between items-center text-white flex-nowrap mt-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start my-10">
            <Link
              href={`/payment?amount=${paramAmount}&point=${paramPoint}`}
              passHref
            >
