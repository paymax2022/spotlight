              ...
              <div className="col-lg-10 mx-lg-auto">
                <div className="text-center mb-lg-0 mb-5">
                  ...
                  <h3 className="ds-3 my-3 fw-regular">
                    Together, We are <span className="fw-bold">Shaping </span> a
                    <br /> <span className="fw-bold">Promising</span> Future for
                    Nigerian <span className="fw-bold">Youth.</span>
                  </h3>
                </div>
              </div>
            </div>
            ...
            <div className="d-flex align-items-center justify-content-center position-relative">
              <div className="pe-3 position-relative z-1 d-none d-md-block">
                <img
                  ...
                  src="/assets/imgs/cta-15/new/image3.png"
                  alt="spotlight"
                />
              </div>
              <div className="pe-3 position-relative z-1">
                <img
                  className="rounded-3 border border-3 border-white"
                  src="/assets/imgs/cta-15/new/image4.png"
                  alt="spotlight"
                />
              </div>
              <div className="pe-3 position-relative z-1">
                <img
                  className="rounded-3 border border-3 border-white"
                  src="/assets/imgs/cta-15/new/image1.png"
                  alt="spotlight"
                />
              </div>
              <div className="pe-3 position-relative z-1">
                <img
                  className="rounded-3 border border-3 border-white"
                  src="/assets/imgs/cta-15/new/movie-1.png"
                  alt="spotlight"
                />
              </div>
              <div className="pe-3 position-relative z-1 d-none d-md-block">
                <img
                  className="rounded-3 border border-3 border-white"
                  src="/assets/imgs/cta-15/new/image6.png"
                  alt="spotlight"
                />
              </div>
              <img
          ...
          <div className="container">
            <div className="text-center">
              ...
              <p className="fs-5 pb-4">
                Our core values inspire creativity, empower youth, uphold
                integrity, and <br className="d-none d-lg-block" />
            ...
            <div className="row">
              <div className="col-lg-6">
                <div className="feature-item mb-5 bg-neutral-100 p-7 rounded-4 hover-up">
                  ...
                  <h4>Creativity</h4>
                  <p>
                    We inspire and nurture the limitless imagination of young
                    talents, encouraging originality, innovation, and artistic
                    expression across music, film, content, entrepreneurship,
                ...
                <div className="feature-item mb-5 bg-neutral-100 p-7 rounded-4 hover-up">
                  ...
                  <h4>Empowerment</h4>
                  <p>
                    We provide tools, mentorship, and platforms that amplify
                    young voices, build confidence, and equip participants to
                    become self-reliant leaders, creators, and agents of
                    positive change.
                  </p>
                  <Link href="#" className="text-primary fs-7 fw-bold">
                    Learn More
              ...
              <div className="col-lg-6">
                <div className="feature-item mb-5 bg-neutral-100 p-7 rounded-4 hover-up">
                  ...
                  <h4>Integrity</h4>
                  <p>
                    We uphold honesty, accountability, and authenticity in all
                    our processes, building a trustworthy platform where youth
                    talents grow with strong character and principled leadership
                    values.{" "}
                  </p>
                  <Link href="#" className="text-primary fs-7 fw-bold">
                    Learm More
                ...
                <div className="feature-item mb-5 bg-neutral-100 p-7 rounded-4 hover-up">
                  ...
                  <h4>Excellence</h4>
                  <p>
                    We commit to world-class standards in training, performance,
                    and execution, fostering a culture of discipline, mastery,
                    and consistent improvement in every area of youth
                    development.
                  </p>
                  <Link href="#" className="text-primary fs-7 fw-bold">
                    Learm More
                ...
                <div className="position-relative d-inline-block z-1">
                  <div className="zoom-img rounded-3">
                    <img
                      ...
                      src="/assets/imgs/team-4/yaw.png"
                      alt="spotlight"
                    />
                  </div>
                  <div className="hover-up">
                    <Link
                      href="#"
                      className="card-team text-start rounded-3 position-absolute top-100 translate-middle-y start-0 end-0 w-100 z-1 backdrop-filter w-auto p-4 mx-6 shadow-1"
                    >
              ...
              <div className="col-lg-4 col-md-6 mb-lg-4 mb-8 text-center">
                <div className="position-relative d-inline-block z-1">
                  <div className="zoom-img rounded-3">
                    <img
                      className="img-fluid w-100"
                      src="/assets/imgs/team-4/aliyu.png"
                      alt="spotlight"
                    />
                  </div>
                  <div className="hover-up">
              ...
              <div className="col-lg-3 col-md-6 mb-lg-4 mb-8 text-center">
                <div className="position-relative d-inline-block z-1">
                  <div className="zoom-img rounded-3">
                    <img
                      className="img-fluid w-100"
                      src="/assets/imgs/team-4/rudeboy.jpg"
                      alt="spotlight"
                    />
                  </div>
                  <div className="hover-up">
                    <Link
                      href="#"
                      className="card-team text-start rounded-3 position-absolute top-100 translate-middle-y start-0 end-0 w-100 z-1 backdrop-filter w-auto p-4 mx-4 shadow-1"
                    >
              ...
              <div className="col-lg-3 col-md-6 mb-lg-4 mb-8 text-center">
                <div className="position-relative d-inline-block z-1">
                  <div className="zoom-img rounded-3">
                    <img
                      className="img-fluid w-100"
                      src="/assets/imgs/team-4/faze.png"
                      alt="spotlight"
                    />
                  </div>
                  <div className="hover-up">
              ...
              <div className="col-lg-3 col-md-6 mb-lg-4 mb-8 text-center">
                <div className="position-relative d-inline-block z-1">
                  <div className="zoom-img rounded-3">
                    <img
                      className="img-fluid w-100"
                      src="/assets/imgs/team-4/kcee.jpeg"
                      alt="spotlight"
                    />
                  </div>
                  <div className="hover-up">
            ...
            <div className="text-center">
              ...
              <h3 className="ds-3 my-3 fw-regular">
                ...
                <span className=" fw-bold">
                  Services <br className="d-none d-md-inline" />{" "}
                </span>
                  ...
                  >
                    <div className="row align-items-center rounded-3 bg-white p-5">
                      <div className="col-lg-5 mb-lg-0 mb-5">
                        <img
                          className="rounded-3"
                          src="/assets/imgs/service-4/new/1.png"
                          alt=""
                        />
                      </div>
                      <div className="col-lg-7">
                        <div className="p-lg-3">
                          ...
                          <p>
                            Our televised talent competition brings music to
                            life on screen. Spotlight’s reality show entertains,
                            inspires, and documents each contestant’s growth,
                            offering viewers a front-row seat as young artists
                            evolve through performances, mentorship, and weekly
                            challenges.
                          </p>
                          <div className="d-flex pt-5">
                            ...
                            <div className="ps-5">
                              ...
                              <p>
                                We scout raw talent across cities through open
                                auditions designed to be accessible, inclusive,
                                and talent-focused.
                              </p>
                            </div>
                          </div>
                          <div className="d-flex">
                            ...
                            <div className="ps-5">
                              ...
                              <p>
                                Our hunt bridges the gap between unknown
                                creatives and the professional music industry.
                              </p>
                            </div>
                          </div>
                        </div>
                  ...
                  >
                    <div className="row align-items-center rounded-3 bg-white p-5">
                      <div className="col-lg-5 mb-lg-0 mb-5">
                        <img
                          className="rounded-3"
                          src="/assets/imgs/service-4/new/2.png"
                          alt=""
                        />
                      </div>
                      <div className="col-lg-7">
                        <div className="p-lg-3">
                          ...
                          <div className="d-flex pt-5">
                            ...
                            <div className="ps-5">
                              ...
                              <p>
                                Fans vote, comment, and connect with contestants
                                in real time across TV and digital platforms..
                              </p>
                            </div>
                          </div>
                          <div className="d-flex">
                            ...
                            <div className="ps-5">
                              ...
                              <p>
                                Beyond drama, our show teaches, inspires, and
                                launches real music careers.
                              </p>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="row align-items-center rounded-3 bg-white p-5">
                      ...
                      <div className="col-lg-7">
                        <div className="p-lg-3">
                          ...
                          <p>
                            Selected talents undergo intensive bootcamp sessions
                            led by top producers, vocal coaches, and branding
                            experts. Through hands-on training, studio
                            experience, and live performances, participants gain
                            industry knowledge and refine their artistic
                            identity for long-term success.
                          </p>
                          <div className="d-flex pt-5">
                            <div className="bg-primary-soft icon-flip position-relative icon-shape icon-xxl rounded-3">
                              <div className="icon">
                            ...
                            <div className="ps-5">
                              ...
                              <p>
                                We bring in leading producers, vocal coaches,
                                and artist managers to groom future stars.
                              </p>
                            </div>
                          </div>
                          <div className="d-flex">
                            ...
                            <div className="ps-5">
                              ...
                              <p>
                                Participants sharpen their skills, collaborate,
                                and record music in a professional studio
                                environment.
                              </p>
                            </div>
                          </div>
                  ...
                  >
                    <div className="row align-items-center rounded-3 bg-white p-5">
                      ...
                      <div className="col-lg-7">
                        <div className="p-lg-3">
                          <h4 className="fw-regular">
                            Sustainable <span className="fw-bold">Growth</span>
                          </h4>
                          <p>
                            Spotlight provides post-show support through
                            structured talent management. We help finalists
                            build their brands, connect with labels, book shows,
                            and access media coverage—ensuring they transition
                            from talent to sustainable, independent, and
                            marketable music professionals.
                          </p>
                          <div className="d-flex pt-5">
                            <div className="bg-primary-soft icon-flip position-relative icon-shape icon-xxl rounded-3">
                              <div className="icon">
                            ...
                            <div className="ps-5">
                              ...
                              <p>
                                We connect talents with record labels, booking
                                agents, and media outlets.
                              </p>
                            </div>
                          </div>
                          <div className="d-flex">
                            ...
                            <div className="ps-5">
                              ...
                              <p>
                                Our team helps manage performances,
                                partnerships, and contracts for alumni artists.
                              </p>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="row align-items-center rounded-3 bg-white p-5">
                      ...
                      <div className="col-lg-7">
                        <div className="p-lg-3">
                          ...
                          <p>
                            At our core, Spotlight is a youth empowerment
                            platform. We create opportunities for young
                            creatives to thrive, develop life skills, gain
                            confidence, and become financially and socially
                            independent through music, mentorship, and exposure.
                          </p>
                          <div className="d-flex pt-5">
                            <div className="bg-primary-soft icon-flip position-relative icon-shape icon-xxl rounded-3">
                              <div className="icon">
                          ...
                          <div className="d-flex">
                            ...
                            <div className="ps-5">
                              ...
                              <p>
                                We prioritize gender balance, regional
                                representation, and fair opportunities for all.
                              </p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="col-12">
                          <div className="input-group d-flex mt-4">
                            ...
                            <textarea
                              ...
                              name="name"
                              placeholder="We are Listening to you"
                        ...
                        <div className="d-flex align-items-center">
                          <div>
                            <div className="form-check mb-2">
                              ...
                              />
                              <label
                                className="form-check-label text-900 fw-bold"
            ...
            <div className="row align-items-end">
              <div className="col-12 col-md-6 me-auto">
                ...
                <span
                  ...
                  data-aos-delay={200}
                >
                  Explore the insights and trends shaping Spotlight
                </span>
              </div>
              ...
              <div className="col-lg-4 text-start">
                ...
                >
                  ...
                  <div className="card-body p-0 bg-white">
                    ...
                    <h6 className="my-3">
                      DSTV, MTVBase, TraceTV, Soundcity, HipTv
                    </h6>
                    <p>
                      Meet our official media partners bringing Spotlight to
                      your screens—TV, radio, and digital platforms across
                      Africa.
                    </p>
                  </div>
                  <Link
              ...
              <div className="col-lg-4 text-start">
                ...
                >
                  ...
                  <div className="card-body p-0 bg-white">
                    ...
                    <h6 className="my-3">
                      Lagos, Rivers, Enugu, Asaba, Abuja, Calabar
                    </h6>
                    <p>
                      Your journey starts here. Register online & join our live
                      auditions to be discovered and trained for stardom...
                    </p>
                  </div>
                  <Link
                    href="#"
