								...
								<div className="row">
									...
									<div className="col-lg-6">
										<div className="ps-lg-6">
											...
											<div className="d-flex mb-2">
												<img src="/assets/imgs/contact-2/icon-4.svg" alt="spotlight" />
											...
											<div className="d-flex mb-2">
												<img src="/assets/imgs/contact-2/icon-5.svg" alt="spotlight" />
