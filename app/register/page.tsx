					...
					<div className="container position-relative z-1">
						<div className="row">
							<div className="col-lg-6">
								...
								<h5 className="ds-5 mt-3 mb-3 text-white">Register as a Contestant</h5>
								<span className="fs-5 fw-medium text-white">The stage is yours, come onboard and showcase <br className="d-none d-lg-block" />
									your talent to the world. No Limits, get onboard and see you are the top <br className="d-none d-lg-block" />
								</span>
								<div className="d-flex pt-6 pb-3 align-items-center">
									...
									<div className="ps-5">
										<h6 className="text-white">Window of Registration</h6>
										<p className="text-white mb-0">2025 Edition commence on July 5th and ends on August 15th <br />Hurry up and share the opportunity with others</p>
									</div>
								</div>
								...
								<div className="d-flex pt-3 pb-3 align-items-center">
									...
									<div className="ps-5">
										<h6 className="text-white">Got other Questions?</h6>
										<p className="text-white mb-0">
