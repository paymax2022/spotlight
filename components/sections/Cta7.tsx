								...
								<div className="col-lg-6 mt-lg-0 mt-5">
									...
									<div className="tab-content" id="nav-tabContent">
										...
										<div className={`${isTab == 3 ? "tab-pane fade show active" : "tab-pane fade"}`} role="tabpanel">
											...
											<div className="row">
												<div className="col-12 col-md-6">
													<p className="text-900">To realize our vision of becoming Africa’s leading talent empowerment brand, Spotlight builds strong partnerships with music industry stakeholders, government agencies, and corporate sponsors.</p>
													<p>We invest in inclusive programming, media collaboration, and digital innovation to reach a wider youth audience.</p>
													<p>By offering career-building platforms, mentorship, and opportunities for professional growth, we aim to uplift young creatives and position them for global musical excellence.</p>
													<p>Our commitment to sustainability and development ensures lasting impact across generations of emerging talent.</p>
													{/* <ul className="list-unstyled phase-items mb-0">
														<li className="d-flex align-items-center mt-3">
															<img src="/assets/imgs/cta-2/check.svg" alt="spotlight" />
