				...
				<div className="container">
					<div className="row">
							...
							<div className="text-start mb-lg-0 mb-5">
								...
								<ul className="list-unstyled my-6">
									<li className="d-flex align-items-center mb-2" data-aos="fade-up" data-aos-delay={0}>
										<img src="/assets/imgs/pricing-1/check-primary.svg" alt="Spotlight" />
								...
								<div className="d-flex align-items-center mb-8 gap-2">
									<Link href="#">
										<img src="/assets/imgs/cta-1/app-1.png" alt="Spotlight" />
									</Link>
									<Link href="#">
										<img src="/assets/imgs/cta-1/app-2.png" alt="Spotlight" />
									</Link>
									<Link href="#">
										<img src="/assets/imgs/cta-1/app-3.png" alt="Spotlight" />
									</Link>
								</div>
						...
						<div className="col-lg-6 text-lg-end text-center">
							<img src="/assets/imgs/cta-1/img-1.png" alt="Spotlight" />
						</div>
					</div>
				</div>
