						...
						<div className="row align-items-center">
							<div className="col-lg-6 text-lg-start text-center">
								<div className="position-relative z-1 d-inline-block mb-lg-0 mb-8">
									<img className="rounded-4 position-relative z-1" src="/assets/imgs/cta-5/img-1.png" alt="Spotlight" />
									<div className="position-absolute bottom-0 start-md-100 start-0 translate-middle-md-x mb-md-8 backdrop-filter rounded-4 px-7 py-4 text-center z-1">
										...
										<div className="d-flex align-items-center justify-content-center py-4">
											<img src="/assets/imgs/features-3/avatar-1.png" alt="Spotlight" />
											<img className="avt-hero z-1" src="/assets/imgs/features-3/avatar-2.png" alt="Spotlight" />
											<img className="avt-hero z-0" src=" assets/imgs/features-3/avatar-3.png" alt="Spotlight" />
										</div>
									...
									<div className="position-absolute top-0 start-0 translate-middle z-0 pt-5">
										<img className="alltuchtopdown" src="/assets/imgs/cta-4/vector.svg" alt="Spotlight" />
									</div>
								</div>
							</div>
