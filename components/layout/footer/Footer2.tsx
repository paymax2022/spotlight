										...
										<div className="col-lg-6 col-md-3">
											...
											<div className="d-flex">
												<Link href="/http://instagram.com/username" className="me-2 hover-up">
													<img className="rounded-3" src="assets/imgs/footer-3/img-inst-1.png" alt="Spotlight" />
												</Link>
												<Link href="/http://instagram.com/username" className="me-2 hover-up">
													<img className="rounded-3" src="assets/imgs/footer-3/img-inst-2.png" alt="Spotlight" />
												</Link>
												<Link href="/http://instagram.com/username" className="me-2 hover-up">
													<img className="rounded-3" src="assets/imgs/footer-3/img-inst-3.png" alt="Spotlight" />
												</Link>
											</div>
											<div className="d-flex mt-2">
												<Link href="/http://instagram.com/username" className="me-2 hover-up">
													<img className="rounded-3" src="assets/imgs/footer-3/img-inst-4.png" alt="Spotlight" />
												</Link>
												<Link href="/http://instagram.com/username" className="me-2 hover-up">
													<img className="rounded-3" src="assets/imgs/footer-3/img-inst-5.png" alt="Spotlight" />
												</Link>
												<Link href="/http://instagram.com/username" className="me-2 hover-up">
													<img className="rounded-3" src="assets/imgs/footer-3/img-inst-6.png" alt="Spotlight" />
												</Link>
											</div>
										</div>
									</div>
						...
						<div className="container">
							<div className="row">
								<div className="d-flex flex-column flex-md-row align-items-center justify-content-between gap-3 py-4 border-top border-white border-opacity-10">
									<p className="text-900 opacity-50 mb-0 fs-7">Copyright © 2024 Spotlight. All Rights Reserved</p>
									<div className="d-flex">
