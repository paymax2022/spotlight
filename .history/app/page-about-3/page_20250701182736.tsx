			...
			<Layout >
					...
					<div className="container">
								...
								<div className="position-relative d-inline-block z-1">
									...
									<div className="hover-up">
										<Link href="#" className="card-team text-start rounded-3 position-absolute top-100 translate-middle-y start-0 end-0 w-100 z-1 backdrop-filter w-auto p-4 mx-6 shadow-1">
											<h6>Aliyu Waziri</h6>
											<span className="d-flex justify-content-between">
												<span className="fs-6 text-600 me-auto">Director: Govt Relations </span>
												<svg xmlns="http://www.w3.org/2000/svg" width={24} height={14} viewBox="0 0 24 14" fill="#007BFF">
													<path d="M17.4177 0.417969L16.3487 1.48705L21.1059 6.24429H0V7.75621H21.1059L16.3487 12.5134L17.4177 13.5825L24 7.0002L17.4177 0.417969Z" fill="#6d4df2" />
												</svg>
											</span>
						...
						<div className="row mt-lg-10 mb-4">
							...
							<div className="col-lg-3 col-md-6 mb-lg-4 mb-8 text-center">
								<div className="position-relative d-inline-block z-1">
									<div className="zoom-img rounded-3">
										<img className="img-fluid w-100" src="/assets/imgs/team-4/img-1.jpg" alt="spotlight" />
									</div>
									<div className="hover-up">
										<Link href="#" className="card-team text-start rounded-3 position-absolute top-100 translate-middle-y start-0 end-0 w-100 z-1 backdrop-filter w-auto p-4 mx-4 shadow-1">
											<h6>Larry Gaaga</h6>
											<span className="d-flex justify-content-between">
												<span className="fs-6 text-600 me-auto">Record Label Executive </span>
												<svg xmlns="http://www.w3.org/2000/svg" width={24} height={14} viewBox="0 0 24 14" fill="#007BFF">
													<path d="M17.4177 0.417969L16.3487 1.48705L21.1059 6.24429H0V7.75621H21.1059L16.3487 12.5134L17.4177 13.5825L24 7.0002L17.4177 0.417969Z" fill="#6d4df2" />
												</svg>
											</span>
							...
							<div className="col-lg-3 col-md-6 mb-lg-4 mb-8 text-center">
								<div className="position-relative d-inline-block z-1">
									<div className="zoom-img rounded-3">
										<img className="img-fluid w-100" src="/assets/imgs/team-4/rudeboy.jpg" alt="spotlight" />
									</div>
									<div className="hover-up">
										<Link href="#" className="card-team text-start rounded-3 position-absolute top-100 translate-middle-y start-0 end-0 w-100 z-1 backdrop-filter w-auto p-4 mx-4 shadow-1">
											<h6>Paul Okoye (RudeBoy)</h6>
											<span className="d-flex justify-content-between">
												<span className="fs-6 text-600 me-auto">Artist & Record Label </span>
												<svg xmlns="http://www.w3.org/2000/svg" width={24} height={14} viewBox="0 0 24 14" fill="#007BFF">
													<path d="M17.4177 0.417969L16.3487 1.48705L21.1059 6.24429H0V7.75621H21.1059L16.3487 12.5134L17.4177 13.5825L24 7.0002L17.4177 0.417969Z" fill="#6d4df2" />
												</svg>
											</span>
							...
							<div className="col-lg-3 col-md-6 mb-lg-4 mb-8 text-center">
								<div className="position-relative d-inline-block z-1">
									<div className="zoom-img rounded-3">
										<img className="img-fluid w-100" src="/assets/imgs/team-4/faze.png" alt="spotlight" />
									</div>
									<div className="hover-up">
										<Link href="#" className="card-team text-start rounded-3 position-absolute top-100 translate-middle-y start-0 end-0 w-100 z-1 backdrop-filter w-auto p-4 mx-4 shadow-1">
											<h6>Faze</h6>
											<span className="d-flex justify-content-between">
												<span className="fs-6 text-600 me-auto">Artist - Judge</span>
												<svg xmlns="http://www.w3.org/2000/svg" width={24} height={14} viewBox="0 0 24 14" fill="#007BFF">
													<path d="M17.4177 0.417969L16.3487 1.48705L21.1059 6.24429H0V7.75621H21.1059L16.3487 12.5134L17.4177 13.5825L24 7.0002L17.4177 0.417969Z" fill="#6d4df2" />
												</svg>
											</span>
							...
							<div className="col-lg-3 col-md-6 mb-lg-4 mb-8 text-center">
								<div className="position-relative d-inline-block z-1">
									<div className="zoom-img rounded-3">
										<img className="img-fluid w-100" src="/assets/imgs/team-4/kcee.jpeg" alt="spotlight" />
									</div>
									<div className="hover-up">
										<Link href="#" className="card-team text-start rounded-3 position-absolute top-100 translate-middle-y start-0 end-0 w-100 z-1 backdrop-filter w-auto p-4 mx-4 shadow-1">
											<h6>KCEE</h6>
                ...
                <div className="container position-relative z-2">
                    <div className="text-center">
                        ...
                        <h3 className="ds-3 my-3 fw-regular">Our <span className=" fw-bold">Services <br className="d-none d-md-inline" /> </span>through <span className="fw-bold">bold</span> strategies</h3>
                    </div>
                            ...
                            <div className="tab-content" id="v-pills-tabContent">
                                    ...
                                    <div className="row align-items-center rounded-3 bg-white p-5">
                                        ...
                                        <div className="col-lg-7">
                                            <div className="p-lg-3">
                                                ...
                                                <p>Our televised talent competition brings music to life on screen. Spotlight’s reality show entertains, inspires, and documents each contestant’s growth, offering viewers a front-row seat as young artists evolve through performances, mentorship, and weekly challenges.</p>
                                                <div className="d-flex pt-5">
                                                    <div className="bg-primary-soft icon-flip position-relative icon-shape icon-xxl rounded-3">
                                                        <div className="icon">
                                                            <img src="/assets/imgs/service-4/icon-1.svg" alt="spotlight" />
                                                        </div>
                                                    </div>
                                                    <div className="ps-5">
                                                        <h6>Nationwide Auditions</h6>
                                                        <p>We scout raw talent across cities through open auditions designed to be accessible, inclusive, and talent-focused.</p>
                                                    </div>
                                                </div>
                                                <div className="d-flex">
                                                    <div className="bg-primary-soft icon-flip position-relative icon-shape icon-xxl rounded-3">
                                                        <div className="icon">
                                                            <img src="/assets/imgs/service-4/icon-2.svg" alt="spotlight" />
                                                        </div>
                                                    </div>
                                                    <div className="ps-5">
                                                        <h6>Talent Discovery Platform</h6>
                                                        <p>Our hunt bridges the gap between unknown creatives and the professional music industry.
                                ...
                                <div className={`${isNav == 2 ? "show active" : ""} tab-pane fade`} id="v-pills-business" role="tabpanel" aria-labelledby="v-pills-business-tab" tabIndex={0}>
                                    <div className="row align-items-center rounded-3 bg-white p-5">
                                        ...
                                        <div className="col-lg-7">
                                            <div className="p-lg-3">
                                                <h4 className="fw-regular"> Engaging<span className="fw-bold"> Life Changing Content</span></h4>
                                                <p>Our televised talent competition brings music to life on screen. Spotlight’s reality show entertains, inspires, and documents each contestant’s growth, offering viewers a front-row seat as young artists evolve through performances, mentorship, and weekly challenges.</p>
                                                <div className="d-flex pt-5">
                                                    <div className="bg-primary-soft icon-flip position-relative icon-shape icon-xxl rounded-3">
                                                        <div className="icon">
                                                    ...
                                                    <div className="ps-5">
                                                        <h6>Viewer Engagement</h6>
                                                        <p>Fans vote, comment, and connect with contestants in real time across TV and digital platforms..</p>
                                                    </div>
                                                </div>
                                                <div className="d-flex">
                                                    <div className="bg-primary-soft icon-flip position-relative icon-shape icon-xxl rounded-3">
                                                    ...
                                                    <div className="ps-5">
                                                        <h6>Entertainment with Purpose</h6>
                                                        <p>Beyond drama, our show teaches, inspires, and launches real music careers.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div className={`${isNav == 3 ? "show active" : ""} tab-pane fade`} id="v-pills-solicitory" role="tabpanel" aria-labelledby="v-pills-solicitory-tab" tabIndex={0}>
                                    <div className="row align-items-center rounded-3 bg-white p-5">
                                        ...
                                        <div className="col-lg-7">
                                            <div className="p-lg-3">
                                                <h4 className="fw-regular"> Operational <span className="fw-bold">Excellence</span></h4>
                                                <p>Selected talents undergo intensive bootcamp sessions led by top producers, vocal coaches, and branding experts. Through hands-on training, studio experience, and live performances, participants gain industry knowledge and refine their artistic identity for long-term success.</p>
                                                <div className="d-flex pt-5">
                                                    <div className="bg-primary-soft icon-flip position-relative icon-shape icon-xxl rounded-3">
                                                        <div className="icon">
                                                            <img src="/assets/imgs/service-4/icon-1.svg" alt="spotlight" />
                                                    ...
                                                    <div className="ps-5">
                                                        ...
                                                        <p>We bring in leading producers, vocal coaches, and artist managers to groom future stars.</p>
                                                    </div>
                                                </div>
                                                <div className="d-flex">
                                                    <div className="bg-primary-soft icon-flip position-relative icon-shape icon-xxl rounded-3">
                                                    ...
                                                    <div className="ps-5">
                                                        ...
                                                        <p>Participants sharpen their skills, collaborate, and record music in a professional studio environment.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="row align-items-center rounded-3 bg-white p-5">
                                        ...
                                        <div className="col-lg-7">
                                            <div className="p-lg-3">
                                                ...
                                                <p>Spotlight provides post-show support through structured talent management. We help finalists build their brands, connect with labels, book shows, and access media coverage—ensuring they transition from talent to sustainable, independent, and marketable music professionals.</p>
                                                <div className="d-flex pt-5">
                                                    <div className="bg-primary-soft icon-flip position-relative icon-shape icon-xxl rounded-3">
                                                        <div className="icon">
                                                            <img src="/assets/imgs/service-4/icon-1.svg" alt="spotlight" />
                                                    ...
                                                    <div className="ps-5">
                                                        <h6>Career Launchpad</h6>
                                                        <p>We connect talents with record labels, booking agents, and media outlets.</p>
                                                    </div>
                                                </div>
                                                <div className="d-flex">
                                                    <div className="bg-primary-soft icon-flip position-relative icon-shape icon-xxl rounded-3">
                                                    ...
                                                    <div className="ps-5">
                                                        <h6>Post-Show Representation</h6>
                                                        <p>Our team helps manage performances, partnerships, and contracts for alumni artists.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="row align-items-center rounded-3 bg-white p-5">
                                        ...
                                        <div className="col-lg-7">
                                            <div className="p-lg-3">
                                                ...
                                                <p>At our core, Spotlight is a youth empowerment platform. We create opportunities for young creatives to thrive, develop life skills, gain confidence, and become financially and socially independent through music, mentorship, and exposure.</p>
                                                <div className="d-flex pt-5">
                                                    <div className="bg-primary-soft icon-flip position-relative icon-shape icon-xxl rounded-3">
                                                        <div className="icon">
                                                            <img src="/assets/imgs/service-4/icon-1.svg" alt="spotlight" />
                                                    ...
                                                    <div className="ps-5">
                                                        ...
                                                        <p>We equip youth with practical skills and access to real music career pathways.</p>
                                                    </div>
                                                </div>
                                                <div className="d-flex">
                                                    <div className="bg-primary-soft icon-flip position-relative icon-shape icon-xxl rounded-3">
                                                    ...
                                                    <div className="ps-5">
                                                        <h6>Inclusive Growth</h6>
                                                        <p>We prioritize gender balance, regional representation, and fair opportunities for all.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="row align-items-center rounded-3 bg-white p-5">
                                        ...
                                        <div className="col-lg-7">
                                            <div className="p-lg-3">
                                                ...
                                                <p>Spotlight collaborates with creative startups in music, media, and tech to drive innovation. We provide visibility, partnership, and promotional opportunities that support emerging businesses aligned with talent development and youth engagement.</p>
                                                <div className="d-flex pt-5">
                                                    <div className="bg-primary-soft icon-flip position-relative icon-shape icon-xxl rounded-3">
                                                        <div className="icon">
                                                            <img src="/assets/imgs/service-4/icon-1.svg" alt="spotlight" />
                                                    ...
                                                    <div className="ps-5">
                                                        ...
                                                        <p>We partner with media and music-tech startups to launch youth-led innovations.</p>
                                                    </div>
                                                </div>
                                                <div className="d-flex">
                                                    <div className="bg-primary-soft icon-flip position-relative icon-shape icon-xxl rounded-3">
                                                    ...
                                                    <div className="ps-5">
                                                        ...
                                                        <p>Spotlight connects creatives with business coaches, helping turn artistic passion into profitable ventures.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div className="position-absolute top-0 start50 translate-middle-x z-0">
                    <img src="/assets/imgs/blog-2/img-bg-line.png" alt="spotlight" />
                </div>
				...
				<section className="section-contact-3 position-relative section-padding fix">
					<div className="container position-relative z-1">
						<div className="text-center">
							...
							<h3 className="ds-3 mt-3 mb-3">Contact Us</h3>
							{/* <p className="fs-5">
											...
											<div className="row mt-5">
												...
												<div className="col-12">
													<div className="input-group d-flex mt-4">
														...
														<textarea className="form-control border border-start-0 ms-0 rounded-start-0 rounded-1 pb-10" name="name" placeholder="We are Listening to you" aria-label="With textarea" />
													</div>
												</div>
												...
												<div className="d-flex align-items-center">
													<div>
														<div className="form-check mb-2">
															...
															<label className="form-check-label text-900 fw-bold" htmlFor="flexCheckChecked"> Reality Talent Hunt show </label>
														</div>
														<div className="form-check mb-2 me-3">
															<input className="form-check-input" type="checkbox" id="flexCheckDefault1" />
															<label className="form-check-label text-900 fw-bold" htmlFor="flexCheckDefault1"> Brand Sponsorship Advert </label>
														</div>
														<div className="form-check mb-2 me-3">
															<input className="form-check-input" type="checkbox" id="flexCheckDefault2" />
															<label className="form-check-label text-900 fw-bold" htmlFor="flexCheckDefault2"> Partnership </label>
														</div>
													</div>
													<div className="ms-8">
														<div className="form-check mb-2 me-3">
															<input className="form-check-input" type="checkbox" id="flexCheckDefault3" />
															<label className="form-check-label text-900 fw-bold" htmlFor="flexCheckDefault3"> Bootcamp & Training </label>
														</div>
														<div className="form-check mb-2">
															<input className="form-check-input" type="checkbox" id="flexCheckDefault4" defaultChecked />
															<label className="form-check-label text-900 fw-bold" htmlFor="flexCheckDefault4"> Youth Empowerment Initiative </label>
														</div>
														<div className="form-check mb-2 me-3">
															<input className="form-check-input" type="checkbox" id="flexCheckDefault5" />
															<label className="form-check-label text-900 fw-bold" htmlFor="flexCheckDefault5"> Others </label>
														</div>
													</div>
												</div>
												<div className="col-12">
									...
									<div className="col-lg-6">
										<div className="ps-lg-6">
											...
											<div className="d-flex mb-2">
												...
												<Link className="ms-2 text-decoration-underline text-900 fs-7" href="#">info@spotlightng.com</Link>
											</div>
											<div className="d-flex mb-2 mb-5">
												<svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} viewBox="0 0 20 20" fill="none">
													<path d="M18.2422 2.96875H1.75781C0.786602 2.96875 0 3.76023 0 4.72656V15.2734C0 16.2455 0.792383 17.0312 1.75781 17.0312H18.2422C19.2053 17.0312 20 16.2488 20 15.2734V4.72656C20 3.76195 19.2165 2.96875 18.2422 2.96875ZM17.996 4.14062C17.6369 4.49785 11.4564 10.6458 11.243 10.8581C10.9109 11.1901 10.4695 11.3729 10 11.3729C9.53047 11.3729 9.08906 11.1901 8.75594 10.857C8.61242 10.7142 2.50012 4.63414 2.00398 4.14062H17.996ZM1.17188 15.0349V4.96582L6.23586 10.0031L1.17188 15.0349ZM2.00473 15.8594L7.06672 10.8296L7.9284 11.6867C8.48176 12.2401 9.21746 12.5448 10 12.5448C10.7825 12.5448 11.5182 12.2401 12.0705 11.6878L12.9333 10.8296L17.9953 15.8594H2.00473ZM18.8281 15.0349L13.7641 10.0031L18.8281 4.96582V15.0349Z" fill="#6B7280" />
												</svg>
												<Link className="ms-2 text-decoration-underline text-900 fs-7" href="#">support@spotlightng.com</Link>
											</div>
											...
											<div className="d-flex mb-2">
												...
												<Link className="ms-2 text-decoration-underline text-900 fs-7" href="#">+234 (815) 949 1618</Link>
											</div>
										</div>
									</div>
								</div>
				...
				<div className="container">
					<div className="row align-items-end">
						<div className="col-12 col-md-6 me-auto">
							...
							<h3 className="ds-3 mt-3 mb-3" data-aos="fade-zoom-in" data-aos-delay={100}>Our Latest News</h3>
							<span className="fs-5 fw-medium" data-aos="fade-zoom-in" data-aos-delay={200}>Explore the insights and trends shaping Spotlight</span>
						</div>
						...
						<div className="col-lg-4 text-start">
							<div className="card border-0 rounded-3 mt-8 position-relative d-inline-flex" data-aos="fade-zoom-in" data-aos-delay={100}>
								...
								<div className="card-body p-0 bg-white">
									...
									<h6 className="my-3">Invite Your Friends and Foes</h6>
									<p>Celebrate your favorite contestant! Send them love, encouragement, and fan support that gets featured on our official channels.</p>
								</div>
						...
						<div className="col-lg-4 text-start">
							<div className="card border-0 rounded-3 mt-8 position-relative d-inline-flex" data-aos="fade-zoom-in" data-aos-delay={200}>
								...
								<div className="card-body p-0 bg-white">
									...
									<h6 className="my-3">DSTV, MTVBase, TraceTV, Soundcity, HipTv</h6>
									<p>Meet our official media partners bringing Spotlight to your screens—TV, radio, and digital platforms across Africa.</p>
								</div>
								<Link href="#" className="position-absolute bottom-0 start-0 end-0 top-0 z-0" />
							</div>
						</div>
