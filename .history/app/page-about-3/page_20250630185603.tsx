						...
						<div className="row pb-9">
							<div className="col-lg-10 mx-lg-auto">
								<div className="text-center mb-lg-0 mb-5">
									...
									<h3 className="ds-3 my-3 fw-regular">Togethsser, We are <span className="fw-bold">Shaping </span> a<br /> <span className="fw-bold">Promising</span> Entertainment Future<span className="fw-bold">.</span></h3>
								</div>
							</div>
						</div>
