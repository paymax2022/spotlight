										...
										<div className={`${isTab == 2 ? "tab-pane fade show active" : "tab-pane fade"}`} role="tabpanel">
											...
											<div className="row">
												<div className="col-12 col-md-6">
													<p className="text-900">We fulfill our mission by organizing nationwide auditions, intensive music bootcamps, and a reality TV show that connects young 
														talents with mentors, industry professionals, and record labels.</p>
													<p>Through training, media exposure, and expert guidance, we nurture raw talent into professional artists ready for global opportunities.</p>
												</div>
