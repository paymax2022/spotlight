						...
						<div className="row align-items-center">
							...
							<div className="col-lg-6">
								<div className="ps-lg-5">
									...
									<p className="mb-5" data-aos="fade-zoom-in" data-aos-delay={300}>A renowned Nigerian music executive, producer, and songwriter known for bridging artists and creating timeless hits. 
										As a Spotlight mentor and label partner, he brings industry expertise, strategic collaborations, and career-launching opportunities for emerging talents ready to shine in Nigeria’s dynamic music scene and beyond</p>
										Founder & CEO: Gaaga Muzik, Gamma Records. 
										<br></br>Def Jam Africa (UniVice President A&R (Artist & Repertiore, Def Jam Africa - West Africa Division)
