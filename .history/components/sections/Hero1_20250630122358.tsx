						...
						<div className="col-lg-6 col-md-12 mb-lg-0 mb-5">
							<div className="pe-2">
								<Link href="#" className="d-flex align-items-center bg-linear-1 d-inline-flex rounded-pill px-2 py-1">
									<span className="bg-primary fs-9 fw-bold rounded-pill px-2 py-1 text-white">Talent Hunt</span>
									<span className="fs-7 fw-medium text-primary mx-2">Spotlight in Focus</span>
								...
								<p className="pe-10 mb-5" data-aos="fade-zoom-in" data-aos-delay={200}>Access top-tier training, mentorship & A-List Music Record Label Giants</p>
