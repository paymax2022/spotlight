					...
					<div className="row">
						<div className="col-lg-4">
							<div className="pe-8 mt-10">
								...
								<h3 className="ds-3 mt-3 mb-3" data-aos="fade-zoom-in" data-aos-delay={100}>Hear what people are saying</h3>
						...
						<div className="col-lg-4">
							<div className="bg-neutral-100 p-5 mt-8 rounded-3 position-relative card-hover" data-aos="fade-zoom-in" data-aos-delay={100}>
								<p className="text-900">Spotlight gave me a voice, exposure, and the tools to grow. From auditions to the finals, I was trained, mentored, and today I’m signed to a label. It changed my life.</p>
							...
							<div className="bg-neutral-100 p-5 mt-5 rounded-3 position-relative card-hover" data-aos="fade-zoom-in" data-aos-delay={200}>
								<p className="text-900">Bootcamp was intense and inspiring. We got vocal training, branding lessons, and studio time with pros. It helped me level up fast and become stage-ready</p>
								<div className="d-flex align-items-center mt-5">
									<img className="avatar-lg" src="/assets/imgs/testimonial-1/avatar-2.png" alt="infinia" />
									<div className="d-flex flex-column">
										<h6 className="ms-3 fs-6 mb-0">Uche Melody, </h6>
										<div className="flag ms-3">
											<img src="/assets/imgs/testimonial-1/flag-2.png" alt="infinia" />
											<span className="fs-8">Singer/Songwriter</span>
										</div>
									</div>
								</div>
								<Link href="#" className="position-absolute top-0 start-0 end-0 bottom-0" />
						...
						<div className="col-lg-4">
							<div className="bg-neutral-100 p-5 mt-5 mt-lg-0 rounded-3 position-relative card-hover" data-aos="fade-zoom-in" data-aos-delay={300}>
								<p className="text-900">Spotlight transforms talent with passion into polished performers. It’s a rare platform that truly invests in real development and long-term music growth.</p>
								<div className="d-flex align-items-center mt-5">
									<img className="avatar-lg" src="/assets/imgs/testimonial-1/avatar-3.png" alt="infinia" />
									<div className="d-flex flex-column">
										<h6 className="ms-3 fs-6 mb-0">Kaycee Vibes</h6>
										<div className="flag ms-3">
											<img src="/assets/imgs/testimonial-1/flag-3.png" alt="infinia" />
											<span className="fs-8">Music Coach</span>
										</div>
									</div>
								</div>
								<Link href="#" className="position-absolute top-0 start-0 end-0 bottom-0" />
							...
							<div className="bg-neutral-100 p-5 mt-5 rounded-3 position-relative card-hover" data-aos="fade-zoom-in" data-aos-delay={400}>
								<p className="text-900">As a parent, seeing my child grow with Spotlight’s guidance was amazing. It’s a safe, professional, and empowering platform for young creatives</p>
								<div className="d-flex align-items-center mt-5">
									<img className="avatar-lg" src="/assets/imgs/testimonial-1/avatar-4.png" alt="infinia" />
									<div className="d-flex flex-column">
										<h6 className="ms-3 fs-6 mb-0">Mrs. Adeniran</h6>
										<div className="flag ms-3">
											
											<span className="fs-8">Parent</span>
										</div>
									</div>
								</div>
								<Link href="#" className="position-absolute top-0 start-0 end-0 bottom-0" />
						...
						<div className="col-lg-4">
							<div className="bg-neutral-100 p-5 mt-5 mt-lg-0 rounded-3 position-relative card-hover" data-aos="fade-zoom-in" data-aos-delay={300}>
								<p className="text-900">We signed a finalist from Spotlight. The platform delivers industry-ready talent — refined, visible, and hungry for growth. It’s a label’s dream pipeline</p>
								<div className="d-flex align-items-center mt-5">
									<img className="avatar-lg" src="/assets/imgs/testimonial-1/avatar-3.png" alt="infinia" />
									<div className="d-flex flex-column">
										<h6 className="ms-3 fs-6 mb-0">Verified Ogbe</h6>
										<div className="flag ms-3">
											<img src="/assets/imgs/testimonial-1/flag-3.png" alt="infinia" />
											<span className="fs-8">GBC Records</span>
										</div>
									</div>
								</div>
								<Link href="#" className="position-absolute top-0 start-0 end-0 bottom-0" />
