					...
					<div className="container">
						<div className="row align-items-center">
							<div className="col-lg-4 col-md-6 mb-lg-0 mb-8 position-relative z-1">
								...
								<h2 className="text-white mt-3 mb-4 fw-medium hover-up">Unique Value Preposition.</h2>
								<ul className="list-unstyled phase-items">
									<li>
										<Link href="#" className="phase-item d-flex align-items-center mb-3">
											...
											<p className="text-white mb-0 ms-3">Deal with Top Music Record Labels</p>
										</Link>
									</li>
									<li>
										<Link href="#" className="phase-item d-flex align-items-center mb-3">
											...
											<p className="text-white mb-0 ms-3">Wide Array of Top Music Video TV Channels</p>
										</Link>
									</li>
									<li>
										<Link href="#" className="phase-item d-flex align-items-center mb-3">
											...
											<p className="text-white mb-0 ms-3">+300M audience - Guaranteed Visibility</p>
										</Link>
									</li>
									<li>
										<Link href="#" className="phase-item d-flex align-items-center mb-3">
