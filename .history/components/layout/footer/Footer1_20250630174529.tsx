					...
					<div className="container-fluid bgft-1">
						<div className="container position-relative z-2">
									...
									<div className="row">
										<div className="col-lg-4 col-md-4 col-6" data-aos="fade-zoom-in" data-aos-delay={200}>
											...
											<div className="d-flex flex-column align-items-start">
												...
												<Link className="hover-effect text-white mb-2 fw-medium fs-6" href="#">Contests</Link>
										...
										<div className="col-lg-4 col-md-4 col-6" data-aos="fade-zoom-in" data-aos-delay={300}>
											...
											<div className="d-flex flex-column align-items-start">
												<Link className="hover-effect text-white mb-2 fw-medium fs-6" href="#">Our Journey</Link>
										...
										<div className="col-lg-4 col-md-4 col-6" data-aos="fade-zoom-in" data-aos-delay={400}>
											...
											<div className="d-flex flex-column align-items-start">
												<Link className="hover-effect text-white mb-2 fw-medium fs-6" href="#">Talent Recruitment & Management</Link>
												<Link className="hover-effect text-white mb-2 fw-medium fs-6" href="#">Reality TV show</Link>
												<Link className="hover-effect text-white mb-2 fw-medium fs-6" href="#">Music Videos Production</Link>
												<Link className="hover-effect text-white mb-2 fw-medium fs-6" href="#">Bootcamping & Workshops</Link>
												<Link className="hover-effect text-white mb-2 fw-medium fs-6" href="#">Music Production</Link>
												<Link className="hover-effect text-white mb-2 fw-medium fs-6" href="#">Training</Link>
											</div>
										</div>
							...
							<div className="row text-center py-4 border-top border-white border-opacity-10">
								<span className="text-white opacity-50" data-aos="fade-zoom-in" data-aos-delay={200}>Copyright © 2025 Spotlight. All Rights Reserved</span>
							</div>
						</div>
					</div>
					<div className="position-absolute top-0 start-50 translate-middle-x z-0">
						<img src="/assets/imgs/footer-1/line-bg.png" alt="spotlight" />
					</div>
					<div className="position-absolute top-0 start-0 z-0">
						<img src="/assets/imgs/footer-1/ellipse-left.png" alt="spotlight" />
					</div>
					<div className="position-absolute top-0 end-0 z-0">
						<img src="/assets/imgs/footer-1/ellipse-right.png" alt="spotlight" />
					</div>
				</div>
			</footer>
