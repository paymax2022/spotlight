    ...
    <Tab.Container activeKey={activeKey} onSelect={handleSelect}>
      <div>
        ...
        >
          ...
          <Nav.Item>
            <Nav.Link eventKey="enrol" id="enrol">
              Register
            </Nav.Link>
          </Nav.Item>
        </Nav>
            ...
            <div className="tf__blog_comment">
              ...
              <div className="tf__single_comment">
                ...
                <div className="tf__single_comment_text">
                  <h4>
                    Obi Adake <span>31 jan 2023 at 03.16 pm</span>
                  </h4>
              ...
              <div className="tf__single_comment">
                ...
                <div className="tf__single_comment_text">
                  <h4>
                    Ibanga Akpan <span>31 jan 2025 at 03.16 pm</span>
                  </h4>
                  <span className="rating">
                    <i className="fas fa-star"></i>
                    <i className="fas fa-star"></i>
              ...
              <div className="tf__single_comment">
                ...
                <div className="tf__single_comment_text">
                  <h4>
                    Edet Abassi <span>31 jan 2023 at 03.16 pm</span>
                  </h4>
                  <span className="rating">
                    <i className="fas fa-star"></i>
                    <i className="fas fa-star"></i>
          ...
          <div className="row">
            <div className="col-xl-6 col-lg-6 wow fadeInLeft">
              <div className="tf__contact_3_text">
                <h2>
                 <span>Contest Form</span> 
                </h2>
                <p>
                  Start your journey to stardom. One ticket is all you need. Grab the opportunity, invite your friends
                </p>
                <a href="#">apply now</a>
              </div>
            </div>
                ...
                <div className="row">
                  ...
                  <div className="col-12">
                    <Form.Select className="select_js">
                      <option value="">Select sa Contest</option>
                      <option value="">Acting</option>
                      <option value="">Music</option>
                      <option value="">Acting & Music</option>
                      <option value="">Comedy</option>
                      <option value="">Comedy/Acting</option>
                    </Form.Select>
                  </div>
                  <div className="col-12">
