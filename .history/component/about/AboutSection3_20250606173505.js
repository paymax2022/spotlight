        ...
        <div className="row">
          ...
          <div className="col-xl-6 col-lg-6 wow fadeInRight">
            <div className="tf__about_2_text">
              ...
              <p>
              The Spotlight" is a multi-stage, multi-platform talent discovery and development initiative anchored by a compelling reality television series, amplified through digital engagement, mentorship programs, and strategic industry linkages. {" "}
              </p>
              <ul>
                <li>
                  <div className="icon">
