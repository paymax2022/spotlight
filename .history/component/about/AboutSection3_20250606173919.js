            ...
            <div className="tf__about_2_text">
              ...
              <ul>
                <li>
                  ...
                  <div className="text">
                    <h4>•	Pan-Nigerian Talent Search</h4>
                    <p>
                      Auditions will be strategically conducted across all six geopolitical zones of Nigeria, ensuring equitable representation and access for talent from diverse cultural backgrounds and creative disciplines
                    </p>
                  </div>
                </li>
                <li>
