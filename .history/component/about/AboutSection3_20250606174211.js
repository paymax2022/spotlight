              ...
              <ul>
                <li>
                  ...
                  <div className="text">
                    <h4>Talent Search</h4>
                    <p>
                      Auditions will be conducted across all six geopolitical zones of Nigeria
                    </p>
                  </div>
                </li>
                <li>
                ...
                <li>
                  ...
                  <div className="text">
                    ...
                    <p>
                      Selected participants will undergo intensive mentorship and skill development workshops
                    </p>
                  </div>
                </li>
                <li>
